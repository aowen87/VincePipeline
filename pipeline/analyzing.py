...
def makeWig(preWig, wigFile):
    '''
        Create a wig file from the "preWig" generated by Mike Roundtree's
        protocol. 
    '''
    fIn  = open(preWig, 'r')
    fOut = open(wigFile, 'w')
